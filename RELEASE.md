...
At any given time there are three revisions of the Prometheus Scrape Target charm [available on CharmHub.io](https://charmhub.io/prometheus-scrape-target-k8s-operator), for each of the following channels:
